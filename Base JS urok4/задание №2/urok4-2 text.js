var works = [
    {
        sit:'Вы живёте в тихой и уютной деревеньке на окрайне страны.\n' +
        ...
        numOpt: 2,
        opt1: '1 - Поспать до обеда\n',
        opt2: '2 - Пойти прогуляться\n',},
    {
        sit: 'Вы решили поспать до обеда.\n' +
        ...
        numOpt: 2,
        opt1: '1 - Пойти прогуляться\n',
        opt2: '2 - Пойти пообедать\n',},
    {
        sit: 'Вы решили пойти прогуляться.\n' +
        ...
        numOpt: 2,
        opt1: '1 - Подождать обед в столовой\n',
        opt2: '2 - Поколоть дров перед обедом\n',},
    {
        sit: 'Вы неожиданно уснули. Опять проснуться\n' +
       'или выйти из матрицы?\n',
        numOpt: 1, // кол-во ответов
        opt1: '1 - проснуться\n',
    }
];
